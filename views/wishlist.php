								...
								<?php if (!empty($_SESSION['wishlist'])) : ?>
									<?php foreach ($_SESSION['wishlist'] as $wishlistProduct) : ?>
										<tr>
													...
													<div class="img-product">
														<?php if (isset($wishlistProduct['image'])) : ?>
															<a href="product?id=<?php echo $wishlistProduct['id']; ?>">
																<img src="<?php echo $wishlistProduct['image']; ?>" alt="" class="mCS_img_loaded">
															</a>
														<?php endif; ?>
													</div>
											...
											<td width="10%" class="text-center">
												<?php if (isset($wishlistProduct)) : ?>
													<form action="wishlist.php" method="post">
														...
														<input type="hidden" name="id" value="<?php echo $wishlistProduct['id']; ?>">
											...
											<td width="10%" class="text-center">
												<?php if (isset($wishlistProduct)) : ?>
													<a href="wishlist.php?remove=<?php echo $wishlistProduct['id']; ?>" class="trash-icon"><i class="far fa-trash-alt"></i></a>
												<?php endif; ?>
											</td>
										</tr>
									<?php endforeach; ?>
